                                    ...
                                    return (
                                        <div key={index} className={` flex flex-row p-1 font-bold text-base ${index%2 === 0?" bg-background bg-opacity-50":"bg-white"} justify-around`}>
                                            ...
                                            <div className=" w-[23%] p-1 flex justify-center items-center">
                                                <p className={` px-3 py-1 w-fit break-words ${decision.etat === "In validation"?" bg-primary":decision.etat === "Validated"?" bg-[#8bc34a]":" bg-[#c02942]"} rounded-3xl text-center p-2`}>{decision.etat}</p>
                                            </div>
                                            <div className=" w-[1px] h-full bg-black"></div>
